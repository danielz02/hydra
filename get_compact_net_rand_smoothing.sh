...
pretrain_prune_finetune_semisup() {
    ...
    --trainer $3 --val_method $4 --gpu $5 --k 1.0 --save-dense --dataset CIFAR10 --noise-std 0.25 --num-models 1 \
    --start-epoch 0;
    ...
    --epochs $7 --dataset CIFAR10 --noise-std 0.25 --num-models 1 --start-epoch 0;
    ...
    --source-net ./trained_models/$1/prune/latest_exp/checkpoint/checkpoint.pth.tar --lr 0.01 --num-models 1 \
    --start-epoch 0;
...
#    --source-net ./trained_models/$1/pretrain/latest_exp/checkpoint/checkpoint.pth.tar --lr 0.01 --num-models 1;
}
...
arch="wrn_28_4"
(
    pretrain_prune_finetune_semisup  "semisup-$arch-trainer_smooth-k_0.1-cifar10-reproduce"  $arch "smooth"   "smooth"  "0,1,2,3"   0.1  20 &
    pretrain_prune_finetune_semisup  "semisup-$arch-trainer_smooth-k_0.05-cifar10-reproduce"  $arch "smooth"   "smooth"  "0,1,2,3"   0.05  20 &
    pretrain_prune_finetune_semisup  "semisup-$arch-trainer_smooth-k_0.01-cifar10-reproduce"  $arch  "smooth"   "smooth"  "0,1,2,3"   0.01  20 ;
);