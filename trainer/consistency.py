...
from utils.utils_ensemble import requires_grad_, accuracy, grad_l2, get_stats, cosine_diversity
        ...
        if i % args.print_freq == 0:
            print(
                ...
                'Acc@5 {top5.avg:.3f}'.format(
                    ...
                    data_time=data_time, loss=losses, loss_con=losses_con, top1=top1, top5=top5
                )
            )
